...
namespace CoreBanking.DataAccessLayer.Migrations
{
    ...
    [Migration("20251106150633_ChangesToDbContext")]
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOpened = new DateTime(2025, 10, 17, 15, 6, 32, 240, DateTimeKind.Utc).AddTicks(3634),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("CoreBanking.Core.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BVN = "20000000009",
                            CreditScore = 40,
                            DateCreated = new DateTime(2025, 10, 7, 15, 6, 32, 240, DateTimeKind.Utc).AddTicks(2912),
                            DateOfBirth = new DateTime(1995, 11, 6, 15, 6, 32, 240, DateTimeKind.Utc).AddTicks(2855),
