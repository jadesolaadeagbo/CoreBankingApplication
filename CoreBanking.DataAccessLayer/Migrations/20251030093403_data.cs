    ...
    public partial class data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a1b2c3d4-1234-5678-9abc-123456789abc"), new DateTime(2025, 9, 30, 9, 34, 2, 636, DateTimeKind.Utc).AddTicks(8801), null, null, "alice.johnson@email.com", "Alice", true, false, "Johnson", "555-0101" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c3d4e5f6-3456-7890-cde1-345678901cde"), "Checking", new Guid("a1b2c3d4-1234-5678-9abc-123456789abc"), new DateTime(2025, 10, 10, 9, 34, 2, 636, DateTimeKind.Utc).AddTicks(8879), null, null, true, false, 1500.00m, "NGN", "1000000001" });
